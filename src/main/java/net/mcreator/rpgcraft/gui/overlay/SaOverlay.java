...
import net.mcreator.rpgcraft.procedures.Mana1Procedure;
...
public class SaOverlay extends RpgCraftModElements.ModElement {
	public SaOverlay(RpgCraftModElements instance) {
		super(instance, 5);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (Mana1Procedure.executeProcedure(ImmutableMap.of("world", world))) {
