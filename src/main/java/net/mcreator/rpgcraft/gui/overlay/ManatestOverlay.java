...
import net.mcreator.rpgcraft.procedures.Mana2Procedure;
...
public class ManatestOverlay extends RpgCraftModElements.ModElement {
	public ManatestOverlay(RpgCraftModElements instance) {
		super(instance, 3);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (Mana2Procedure.executeProcedure(ImmutableMap.of("world", world))) {
