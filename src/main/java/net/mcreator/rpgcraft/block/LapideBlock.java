...
package net.mcreator.rpgcraft.block;
...
public class LapideBlock extends RpgCraftModElements.ModElement {
	@ObjectHolder("rpg_craft:lapide")
	public static final Block block = null;
	public LapideBlock(RpgCraftModElements instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(RpgItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
