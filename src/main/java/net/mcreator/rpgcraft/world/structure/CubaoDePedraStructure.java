...
package net.mcreator.rpgcraft.world.structure;
...
public class CubaoDePedraStructure extends RpgCraftModElements.ModElement {
	public CubaoDePedraStructure(RpgCraftModElements instance) {
		super(instance, 12);
	}
